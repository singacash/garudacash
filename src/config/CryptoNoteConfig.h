...
// Copyright (c) 2018, GarudaCash Project
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1232311; //XiDR
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 30; //30 mins
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1000000000000);//1Trillion
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(930000000000); //93%
...
const size_t   CRYPTONOTE_DISPLAY_DECIMAL_POINT              = 0;//No decimal

const uint64_t MINIMUM_FEE                                   = UINT64_C(100);

/* This section defines our minimum and maximum mixin counts required for transactions */
const uint64_t MINIMUM_MIXIN_V1                              = 0;
const uint64_t MAXIMUM_MIXIN_V1                              = 1; //100
...
const uint32_t UPGRADE_HEIGHT_V4                             = 3; // 350000 Upgrade height for CN-Lite Variant 1 switch.
...
const char     CRYPTONOTE_NAME[]                             = "GarudaCash";
...
const int      P2P_DEFAULT_PORT                              =  28674;
const int      RPC_DEFAULT_PORT                              =  28675;
...
const char     LATEST_VERSION_URL[]                          = "http://garudacash.org/latest";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xb7, 0x10, 0x50, 0x7c, 0xe1, 0x66, 0x6b, 0x57, 0x7d, 0xd9, 0x79, 0xa2, 0xa4, 0xb1, 0x31, 0xe2  }
};

const char* const SEED_NODES[] = {
  "206.189.84.122:28674",//sgp1-grc01
  "159.89.125.183:28674", //tor1-grc02
  "104.248.218.104:28674", //sfo2-grc03
